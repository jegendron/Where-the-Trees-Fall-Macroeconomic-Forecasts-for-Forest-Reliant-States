...
df = pd.read_excel (directory+"ForecastData322.xlsx")
#print(df.head(1))
...
fig.tight_layout()
fig.savefig(directory+'322employData.png', dpi=1200)
...
ax1.plot(x, eWI, 'k', label='Wisconsin',linewidth=1)
ax1.plot(x, feWI, '--k', label='Forecast',linewidth=1)
...
fig.legend(frameon=True, shadow=True,facecolor="white")
fig.tight_layout()
fig.savefig(directory+'322employForecast.png', dpi=1200)
...
fig.legend(frameon=True, shadow=True,facecolor="white")
fig.tight_layout()
fig.savefig(directory+'322employRC.png', dpi=1200)
...
fig.legend(frameon=True, shadow=True,facecolor="white")
fig.tight_layout()
plt.savefig(directory+'322outputData.png', dpi=1200)
...
fig.legend(frameon=True, shadow=True,facecolor="white")
fig.tight_layout()
plt.savefig(directory+'322outputForecast.png', dpi=1200)
...
fig.legend(frameon=True, shadow=True,facecolor="white")
fig.tight_layout()
plt.savefig(directory+'322outputRC.png', dpi=1200)
...
fig.legend(frameon=True, shadow=True,facecolor="white")
fig.tight_layout()
plt.savefig(directory+'322wageData.png', dpi=1200)
...
fig.legend(frameon=True, shadow=True,facecolor="white",bbox_to_anchor = [.95, .79])
fig.tight_layout()
plt.savefig(directory+'322wageForecast.png', dpi=1200)
...
fig.legend(frameon=True, shadow=True,facecolor="white")
fig.tight_layout()
plt.savefig(directory+'322wageRC.png', dpi=1200)
...
fig.legend(frameon=True, shadow=True,facecolor="white")
fig.tight_layout()
plt.savefig('G:/SYNC/School/VT/RESEARCH/Dissertation/Working Research/Forestry (both papers)/Paper 2/Old Files (2021)/321 & 322/Data/Modeling/Graphs322/State/Data Graph/KeyNumFirm.png', dpi=1200)
...
fig.legend(frameon=True, shadow=True,facecolor="white")
fig.tight_layout()
plt.savefig(directory+'322numfirmData.png', dpi=1200)
...
fig.legend(frameon=True, shadow=True,facecolor="white")
fig.tight_layout()
plt.savefig(directory+'322numfirmRC.png', dpi=1200)
