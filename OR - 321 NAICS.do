...
varsoc output price employ wage numfirm
	*predominantly records 2 lags

vecrank output price employ wage numfirm, lags(2)
*trend(constant)
	*results in Rank = 3 (whether or not I use the options I've commented out..?)

******USE A VEC MODEL******
	
*VEC MODEL
vec output price employ wage numfirm, rank(3) lags(2) noetable
