...
*trend(constant)
	*results in Rank = 1 (whether or not I use the options I've commented out..?)

******USE A VEC MODEL******
	
*VEC MODEL
vec output price employ wage numfirm, rank(1) lags(4) noetable
