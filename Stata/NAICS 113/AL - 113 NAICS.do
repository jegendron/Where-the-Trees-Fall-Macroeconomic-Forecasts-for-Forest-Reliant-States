...
varsoc output price employ wage numfirm
	*predominantly records 1 lag

vecrank output price employ wage numfirm, lags(1)
	*results in Rank = 1 (IFF 5% Crit Val > Trace Stat)
		*Cointegration present IF Rank = 0 AND Trace Stat > Crit Val)

******USE A VEC MODEL******
	
*VEC MODEL
vec output price employ wage numfirm, rank(1) lags(1) noetable
...
******ROBUSTNESS CHECK******
vec output price employ wage numfirm if quarter <= tq(2016q1), rank(1) lags(1) noetable
